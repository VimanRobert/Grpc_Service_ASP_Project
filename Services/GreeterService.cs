...
using Grpc.Core;
using Grpc_Service_ASP_Project;

namespace Grpc_Service_ASP_Project.Services
{
    public class GreeterService : Greeter.GreeterBase
    {
        ...
        public override Task<SResponse> SendStatus(SRequest request, ServerCallContext context)
        {
            ...
            SResponse sRes = new();
            sRes.StatusInfo.AddRange(statusList.Skip(request.Name - 1).Take(1));
        ...
        public override async Task<SResponse> SendStatusCS(IAsyncStreamReader<SRequest>requestStream, ServerCallContext context)
        {
            ...
            {
                sRes.StatusInfo.Add(statusList.Skip(message.Name - 1).Take(1));
            }
            return sRes;
        }
